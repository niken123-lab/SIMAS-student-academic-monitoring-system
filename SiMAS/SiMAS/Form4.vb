...
Public Class Form4
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        ...
        Try
            Call Koneksi()
            Dim sql As String = "UPDATE admin SET password=@pass WHERE email=@Email"
            Dim cmd As New MySqlCommand(sql, conn)
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        Try
            ...
            Dim sql As String = "UPDATE admin SET username=@username, email=@newEmail WHERE email=@oldEmail"
            Dim cmd As New MySqlCommand(sql, conn)
            cmd.Parameters.AddWithValue("@username", newNama)
            ...
            Else
                MessageBox.Show("Gagal mengubah data admin.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End If
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs)
        If MessageBox.Show("Apakah anda yakin ingin logout?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            ClearSession()
            Form6.TextBox1.Clear()
            Form6.TextBox2.Clear()
            Form6.Show()
            Me.Hide()
        End If
    End Sub
