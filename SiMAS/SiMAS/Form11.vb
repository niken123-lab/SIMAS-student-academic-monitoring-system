...
Public Class Form11
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        ...
        Try
            ...
            If DataGridView1.SelectedRows.Count = 0 Then
                MessageBox.Show("Pilih satu data siswa yang ingin dihapus!", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Return
            End If

            ' Pastikan semester dipilih
            If String.IsNullOrWhiteSpace(ComboBox1.Text) Then
                MessageBox.Show("Pilih semester terlebih dahulu sebelum menghapus data!", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Return
            End If
            ...
            ' Konfirmasi
            If MessageBox.Show("Yakin ingin menghapus data absensi siswa:" & vbCrLf &
                           nama & " (NISN: " & nisn & ") untuk semester " & ComboBox1.Text & "?",
            ...
            ' Eksekusi hapus data
            Koneksi()
            Dim sql As String = "DELETE FROM rekap_absensi WHERE nisn=@nisn AND semester=@semester"
            Cmd = New MySqlCommand(sql, conn)
